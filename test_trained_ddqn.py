...
if __name__ == '__main__':
    ...
    if load_checkpoint:
        agent.q_eval.load_state_dict(torch.load(os.path.join(agent.q_eval.checkpoint_dir, "ddqn_q_eval_trained")))
        agent.q_next.load_state_dict(torch.load(os.path.join(agent.q_next.checkpoint_dir, "ddqn_q_next_trained")))
